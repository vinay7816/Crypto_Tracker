...
const List = ({item}) => {
  ...
  return (
    ...
    <td className='pricing td-pricing'>
        ...
        <div className={item.price_change_percentage_24h>0?"price-percentage td-price-percentage":"price-negative td-price-percentage"}>{item.price_change_percentage_24h
        .toFixed(2)}%</div>
